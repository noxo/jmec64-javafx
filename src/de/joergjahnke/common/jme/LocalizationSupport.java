...
public class LocalizationSupport {
     ...
     */
    public static final String COMMON_MESSAGES = "/res/l10n/commonMessages.properties";
    /**
    ...
    /**
     * Load a localized file.
     * This method will take care of identifying the proper filename.
     * E.g. when passing the file name "foo.txt" on a German device, this method
     * will first try to load the file "foo_de.txt" and if it does not find this
     * file, it will default to "foo.txt".
     * 
     * @param filename  file to load
     * @param locale    locale to use
     * @return  stream with file contents, will be null if the file cannot be found
     */
    public static InputStream loadLocalizedFile(final String filename, String locale) {
        InputStream in = null;
    ...
    public static boolean initLocalizationSupport() {
        return initLocalizationSupport(System.getProperty("microedition.locale"), COMMON_MESSAGES);     // NOI18N
    }

    /**
     * Initializes localization support based on currently set locale (obtained
     * from "microedition.locale" system property).
     * 
     * @param messages  path to the resource bundle
     * @return true if the intialization was succesfull, false if there was any problem.
     */
    public static boolean initLocalizationSupport(final String messages) {
        return initLocalizationSupport(System.getProperty("microedition.locale"), messages);     // NOI18N
    }
     ...
     */
    protected static String _convertString(String theString) {
        char aChar;
